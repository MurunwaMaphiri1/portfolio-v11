import ghCat from "@/public/images/386745.jpg";
...
export const GHLink = () => {
  return (
    <a
      ...
      href="https://github.com/MurunwaMaphiri1"
      target="_blank"
      rel="noreferrer"
    >
      <span
      ...
      <span className="space-y-0.5 px-6 pb-6">
        ...
        <span className="block text-sm">Projects I&apos;ve worked on in my spare time</span>
      </span>
    </a>
  );
};
