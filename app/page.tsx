const Home = () => {
  return (
    <div className="p-3">
      <section className="md:mt-8 lg:mt-10 pt-8 pb-16 max-w-3xl mx-auto">
          ...
          <div className="mt-5 text-zinc-600 dark:text-zinc-400">
            Beyond coding, I'm drawn to how things work under the hood. I enjoy exploring computer networks, working with APIs and reading up on system design. If I'm not coding, you'll probably find me tweaking a project, watching anime/football or gaming.
          </div>
          <div className="mt-5 text-zinc-600 dark:text-zinc-400">
